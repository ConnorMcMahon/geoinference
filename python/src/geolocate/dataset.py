...
class Dataset(object):
    ...
    def post_iter(self):
        ...
        for line in fh:
            post = json.loads(line.decode("ascii"))
    ...
    for i in range(max_open_temp_files):
        try:
            ...
            for uid,posts in user_posts.items():
                user_fh.write('%s\n' % json.dumps({'user_id':uid,'posts':posts}))
